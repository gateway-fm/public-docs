    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          High-performance infrastructure for Polygon zkEVM protocol networks
        </p>
            ...
            <div className="row">
              <div className="col col--10 col--offset-1">
                ...
                <p className={styles.sectionDescription}>
                  ...
                  specifically optimized for the Polygon zkEVM protocol networks. Built on the robust Erigon
                  architecture and maintained by Gateway.fm, it delivers unparalleled efficiency, reliability, and
                  synchronization speeds for your blockchain infrastructure needs.
                </p>
              </div>
            </div>
          </div>
