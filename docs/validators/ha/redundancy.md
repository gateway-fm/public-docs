...
- [Validator Client](/category/validator-clients/) + Wallet -- use manual failover. Inactivity leaks are
  ...
  and losing one of more validators (see more [Slashing and Penalties](../basics/slashing-and-penalties.md).
...
clients](/category/validator-clients/), but if you know about it and [monitor it properly](monitoring.md),
it won't cause a big risk.

## Read More

- [Slashing & Penalties](../basics/slashing-and-penalties.md)
