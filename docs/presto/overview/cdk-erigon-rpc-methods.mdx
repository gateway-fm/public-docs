...
For more details, refer to the **Polygon zkEVM API Documentation**: [Polygon zkEVM Docs](https://docs.polygon.technology/docs/zkEVM/architecture/protocol/etrog-upgrade/#supported-opcodes).
