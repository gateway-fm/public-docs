...
<summary>
  What versions of Erigon should be used for different CDK-Erigon forks, and are beta26 and beta27
  compatible?
</summary>
...
<summary>
  What is the upgrade path for forkid support in cdk-erigon, and what improvements does forkid.13
  introduce?
</summary>
...
<summary>
  Is a Private zkRollup a viable solution for my use case compared to public networks like Polygon
  or BNB?
</summary>
...
<summary>
  What are the benefits of using ZK rollups compared to Optimistic rollups like Arbitrum? How do
  their costs and use cases compare?
</summary>
...
<summary>
  Who controls the keys in a L2 Rollup? Is this an industry standard and does it pose any risks to
  customers?
</summary>
...
<summary>
  Does your EVM support deploying existing compiled contracts with an EVM version of ‘Paris’ or
  later, without additional code modifications?
</summary>
...
<summary>
  Are{" "}
  <a href="https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-eth#eth-call">
    stateOverrides
  </a>{" "}
  supported in `eth_call`?
</summary>
...
<summary>
  Are{" "}
  <a href="https://geth.ethereum.org/docs/developers/evm-tracing/custom-tracer">
    custom call tracers
  </a>{" "}
  supported in the `debug_traceCall` API?
</summary>
...
<summary>
  Can custom chain id `l2_chain_id` be set for testnet deployments, or is it restricted to mainnet
  only?
</summary>
...
<summary>
  Do we currently support EIP-2718 (Typed Transaction Envelope) in legacy `vdk-validium-node` and
  `cdk-erigon`?
</summary>
