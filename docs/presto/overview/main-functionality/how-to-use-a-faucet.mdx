...
1. Navigate to “**Faucet**” in the L2 [Presto L2 Dashboard](../presto-ui-dashboards/presto-l2-dashboard).
...
* [How To Use Metamask with Presto](how-to-use-metamask-with-presto)
* [How to use a Block Explorer](how-to-use-a-block-explorer)
