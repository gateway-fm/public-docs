---
title: Enterprise vs Paid — what is the difference?
---

# Enterprise vs Paid — what is the difference?

Presto offers both a paid, solution for paid rollups as well as enterprise plan.
...
1. Full set of customization options (see [Presto Customization Options](presto-customization-options))
...
See also: [How to Become an Enterprise Customer?](how-to-become-an-enterprise-customer.mdx)
