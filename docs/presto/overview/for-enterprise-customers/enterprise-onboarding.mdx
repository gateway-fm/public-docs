...
see also[ How to Become an Enterprise Customer?](how-to-become-an-enterprise-customer.mdx) and [Enterprise vs Paid — what is the difference?](enterprise-vs-paid-what-is-the-difference.mdx)
...
\*This step could be **free** for the client, but time-limited. \~2-4 tps (\*see [What are the conditions of the trial](../pricing-and-trial/what-are-the-conditions-of-the-trial.mdx))
